...
### Fixed
- Prefix the exact SettingsViewCompiler fallback icon expression in HA Ingress assets and both direct and JSON-escaped `logo="/` values in Settings view responses.
